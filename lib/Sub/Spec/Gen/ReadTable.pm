...
=head2 gen_read_table_func(%args) -> [STATUS_CODE, ERR_MSG, RESULT]
...
=item * B<case_insensitive_search> => I<bool> (default C<1>)
...
=item * B<default_show_field_names> => I<bool>
...
=item * B<enable_search> => I<bool> (default C<1>)
...
=item * B<word_search> => I<bool> (default C<0>)
